...
from .views import RatesView, AccountCreateView, PlaceView, AccountByTelegramIdView, AudioListView, AccountDeleteAPIView, WorkerCreateView, WorkerAccountByTelegramIdView
